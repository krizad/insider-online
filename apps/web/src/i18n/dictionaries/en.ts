...
export const en: Dictionary = {
  ...
  gameDetectiveMath: {
    loading: "Loading Detective Math...",
    yourRole: "Your Role",
    yourScore: "Your Score",
    roleInformer: "INFORMER",
    roleConspirator: "CONSPIRATOR",
    roleDetective: "DETECTIVE",
    pts: "pts",
    setupPhase: "Setup Phase",
    informerSetupDesc: "You are the Informer! Look at your cards and set a Target Number.",
    waitingInformerSetup: "Waiting for the Informer to set the Target Number...",
    yourHand: "Your Hand",
    enterTargetNumber: "Enter a Target Number that relates to your cards",
    targetNumberPlaceholder: "e.g. 7, 13, 100...",
    confirmNumber: "Confirm Number",
    waitingInformer: "Waiting for Informer to set a number...",
    playingPhase: "Playing Phase",
    round: "Round",
    targetNumberIs: "The Target Number is",
    conspiratorDoesNotKnow: "You don't know the number! Play a card to bluff.",
    playCardPrompt: "It's your turn. Select a card to play.",
    waitingFor: "Waiting for",
    playedCards: "Played Cards",
    discussionPhase: "Discussion Phase",
    discussionDesc: "Discuss why you played your cards. The Informer goes first.",
    votingPhase: "Voting Phase",
    whoIsConspirator: "Who is the Conspirator?",
    conspiratorWait: "You are the Conspirator! Wait for others to vote...",
    votes: "Votes:",
    lockedOn: "Locked on",
    lockVote: "Lock Vote",
    scoringPhase: "Scoring Phase",
    conspiratorWas: "The Conspirator was",
    youCaughtConspirator: "You caught the Conspirator!",
    conspiratorEscaped: "The Conspirator escaped!",
    youWereCaught: "You were caught!",
    youEscaped: "You escaped and fooled them all!",
    playNextRound: "Play Next Round",
    waitingHostNextRound: "Waiting for host to start next round..."
  }
};
